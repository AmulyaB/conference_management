  ...
  <div class="container">
	<div class="row">
  		...
  		<div class="column2">';
			...
			$query = "SELECT DISTINCT Fname,Mname,Lname,DOB,P.Pan_no,Passwd FROM PERSON P,REVIEWER_PAN R,PC_CHAIRMAN C WHERE (C.Pan_no = P.Pan_no AND C.Member_id = '$mem') OR (R.Pan_no = 						P.Pan_no AND R.Member_id = '$mem')";
