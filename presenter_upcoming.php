...
<body>';
	...
	$query1 = "SELECT * FROM CONFERENCE C WHERE Date > '$date' "; 
	...
	if($num_rows == 0){
		...
		$query2 = "SELECT DISTINCT C.C_name AS 'CONFERENCE NAME',Date AS DATE,Place AS PLACE,Topic AS TOPIC FROM CONFERENCE C WHERE Date > '$date'";
