...
echo'
<html>
<head><title>Live conferences</title> 
...
<?php
	...
	$query1 = "SELECT DISTINCT C.C_name AS 'CONFERENCE NAME',Date AS DATE,Place AS PLACE,Topic AS TOPIC FROM CONFERENCE C,PAPER P,AUTHORED_BY WHERE Date = '$date' AND C.C_name = P.C_name AND P.Paper_id = AUTHORED_BY.Paper_id AND AUTHORED_BY.Author_id = '$mem'";
	...
	print "<table border = '1' style='width: 100%;height: 15%;position:relative; top:50px; '><caption><h2> Upcoming Conferences <br /><br /></h2></caption>";
	print "<tr align = 'left'>";
	$num_rows = mysql_num_rows($result2);
